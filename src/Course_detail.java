...
public class Course_detail extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Course_detail
     */
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("ID\tNAME OF STUDENT ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                  ...
                  try
        {
           ...
           Statement st=cn.createStatement();
            ...
            String load="select * from course_reg where c_name='"+a+"'";
           ...
           {
               JOptionPane.showMessageDialog(null,"Invalid course ","Access Denied",JOptionPane.ERROR_MESSAGE);
           }
        }
             catch(Exception e)
             {
                   JOptionPane.showMessageDialog(null,"Please Enter Course Name","Access Denied",JOptionPane.ERROR_MESSAGE);
