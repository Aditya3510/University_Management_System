    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
                      ...
                      try
        {
           ...
           Statement st=cn.createStatement();
            ...
            String load="select * from admin where username='"+username+"' and password='"+password+"'  ";
        ...
        if(Menu.a==1)
        {
           ...
           {
          Student_result_insertion si=new Student_result_insertion();
           si.setVisible(true);
        ...
        cd.show();
         ...
         jPasswordField1.setText("");
             ...
             {
               JOptionPane.showMessageDialog(null,"Missing Username or Password","Access Denied",JOptionPane.ERROR_MESSAGE); 
